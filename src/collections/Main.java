...
//        System.out.println("Is cycle present in the linked list: " + cil.isCylicPresentMethod2(cil.get(1)));
//        System.out.println("Is cycle present in the linked list: " + cil.isCyclePresent(cil.get(1)));
